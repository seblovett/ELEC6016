...
%  <+Last Edited: Wed 02 Apr 2014 22:43:34 BST by seblovett on seblovett-Ubuntu +>
...
\lstinputlisting[lastline=18,caption={Loading initial constants},frame=single,label=lstsetup]{../Implementation/transform.asm}
...
\lstinputlisting[firstline=19, lastline=24,caption={Handshaking protocol for switch reading},frame=single,label=lsthandshake1]{../Implementation/transform.asm}
...
\lstinputlisting[firstline=25, lastline=35,caption={Affine transform for x2},frame=single,label=lstaffinex]{../Implementation/transform.asm}
...
\lstinputlisting[firstline=41, lastline=46,caption={End of loop code to display results and return to the beginning of the loop},frame=single,label=lsthandshake2]{../Implementation/transform.asm}
